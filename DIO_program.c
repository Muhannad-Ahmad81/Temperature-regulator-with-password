...
/*Initiate all pins as input (if u want change it do that from DIO_configer.h)*/
	...
	if(Copy_u8PinId <= DIO_u8_PIN7)
	{
		switch (Copy_u8PortId)
		{
			case DIO_u8_PORTA:
				...
				{
					case DIO_HIGH:SET_BIT(DIO_u8_PORTA_REG,Copy_u8PinId);break;
					case DIO_LOW: CLR_BIT(DIO_u8_PORTA_REG,Copy_u8PinId);break;
			...
			case DIO_u8_PORTB:
				switch (Copy_u8PinValue)
				{
					case DIO_HIGH:SET_BIT(DIO_u8_PORTB_REG,Copy_u8PinId);break;
					case DIO_LOW: CLR_BIT(DIO_u8_PORTB_REG,Copy_u8PinId);break;
					default : Local_u8ErrorState = STD_TYPES_NOK;
				}		
			break;
			case DIO_u8_PORTC:
				switch (Copy_u8PinValue)
				{
					case DIO_HIGH:SET_BIT(DIO_u8_PORTC_REG,Copy_u8PinId);break;
					case DIO_LOW: CLR_BIT(DIO_u8_PORTC_REG,Copy_u8PinId);break;
					default : Local_u8ErrorState = STD_TYPES_NOK;
				}		
			break;
			case DIO_u8_PORTD:
				switch (Copy_u8PinValue)
				{
					case DIO_HIGH:SET_BIT(DIO_u8_PORTD_REG,Copy_u8PinId);break;
					case DIO_LOW: CLR_BIT(DIO_u8_PORTD_REG,Copy_u8PinId);break;
					default : Local_u8ErrorState = STD_TYPES_NOK;
				}		
			break;
			default :
	...
	if((Copy_u8PortId <= DIO_u8_PORTD) && (Copy_u8PinId <= DIO_u8_PIN7) && (Copy_pu8ReturnedPinValue != NULL))
	{
		switch (Copy_u8PortId)
		{
			case DIO_u8_PORTA:
				...
				{
					*Copy_pu8ReturnedPinValue = DIO_LOW;
				}	
				else
				{
					*Copy_pu8ReturnedPinValue = DIO_HIGH;
				}
			break;
			case DIO_u8_PORTB:
...
//////////////////////
/* IO Ports */
u8    DIO_u8SetPortDirection(u8 Copy_u8PortId ,u8 Copy_u8PinDirction )
{
		u8 Local_u8ErrorState = STD_TYPES_OK;
		...
		{
			switch(Copy_u8PortId)
			{         case    DIO_u8_PORTA:  DIO_u8_PORTA_REG = Copy_u8PinDirction ;break;
		           	  case    DIO_u8_PORTB:  DIO_u8_PORTB_REG = Copy_u8PinDirction ;break;
		              case    DIO_u8_PORTC:  DIO_u8_PORTC_REG = Copy_u8PinDirction ;break;
		              case    DIO_u8_PORTD:  DIO_u8_PORTD_REG = Copy_u8PinDirction ;break;
		}
